...
template <> CandidateString get_at(const vector<CandidateString> &candidates, const unsigned int iCandidate) {
...
template <> vector<CandidateString> get_ref(const vector<CandidateString> &vect) { return vect; }
